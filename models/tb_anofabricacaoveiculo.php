<?php 
	...
	class TB_AnoFabricacaoVeiculo extends CI_Model {
		...
		function TB_AnoFabricacaoVeiculo($config_database = "autocloudv2"){
	    	
	        parent::__construct();

	        
	        $this->nome_tabela = "TB_AnoFabricacaoVeiculo";
	    ...
	    function lista($id_modelo) {
	        //load database
			$this->data_base_object = $this->load->database($this->config_database,true);

			//cria consulta
			$this->data_base_object->where('TB_ModeloVeiculo_id = ', $id_modelo);
